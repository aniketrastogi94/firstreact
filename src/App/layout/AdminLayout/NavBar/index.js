                ...
                <header className={headerClass.join(' ')}>
                    <div className="m-header">
                        ...
                        <a href={DEMO.BLANK_LINK} className="b-brand">
                            <div className="b-bg">
                                <img src="https://res.cloudinary.com/dlwatmwd3/image/upload/v1552407627/Vyorius/logo.png" alt="logo" height="50px"/>
                            </div>
                    ...
                    <div className="collapse navbar-collapse" style={{backgroundColor:"white"}}>
                        <NavLeft />
...
const Withoutnavbar = NavBar ;
const Withnavbar = connect(mapStateToProps, mapDispatchToProps) (NavBar)
